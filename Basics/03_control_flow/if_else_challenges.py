...
numbers_input = input("Enter Four Number ")
first_num = numbers_input.split(" ").pop(0)
second_num = numbers_input.split(" ").pop(1)
third_num = numbers_input.split(" ").pop(2)
fourth_num = numbers_input.split(" ").pop(3)
...
social_studies_marks = marks_input.split(" ").pop(1)
science_marks = marks_input.split(" ").pop(2)
print(f"Your Report")
total_marks = int(maths_marks) + int(social_studies_marks) + int(science_marks)
if(total_marks > 120):
    print(f"\tYour Marks {total_marks} Out of 300")
    if(int(maths_marks) >= 33 and int(social_studies_marks) >= 33 and int(science_marks) >= 33):
        print(f"You Passes\nMathematics : {maths_marks}\nSocial Science : {social_studies_marks}\nScience : {science_marks}")
    else:
        print("Go and Study !")
...
spam_keywords = comment_text.count("make a lot of money") + comment_text.count("buy now") + comment_text.count("subscribe this") + comment_text.count("click this")
print(f"Spam Comments {spam_keywords}")
...
if("harry".lower() in  post_content.lower()):
    search_result = "Yes Present"
else:
    search_result = "No Not-Present"
print(post_content)
