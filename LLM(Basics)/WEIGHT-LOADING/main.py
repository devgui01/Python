"""Note that in these we use gpt2 tokenizer, as o200k_base I mean gpt-oss tokenizer is not compatible with gpt2 weights"""
...
token_ids = generate_text_simple(
    model=gpt,
    idx=text_to_token_ids("Hello My Friend", tokenizer).to(device),
    max_new_tokens=50,
